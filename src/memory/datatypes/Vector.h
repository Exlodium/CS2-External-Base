...
public:
	...
	Vector WorldToScreen( ViewMatrix_t matrix ) const 
	{
		...
		float x = Window::m_iWidth * .5f;
		float y = Window::m_iHeight * .5f;

		x += 0.5f * _x * Window::m_iWidth + 0.5f;
		y -= 0.5f * _y * Window::m_iHeight + 0.5f;
